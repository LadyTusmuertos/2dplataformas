...
public class CharacterController2D : MonoBehaviour {
    ...
    private void MoveHorizontally(ref Vector2 deltaMovement)
    {
        ...
        for (int i = 0; i < TotalHorizontalRays; ++i) {
            ...
            if (!rayCastHit)
                continue;
            if (i == 0 && HandleHorzontalSlope(ref deltaMovement, Vector2.Angle(rayCastHit.normal, Vector2.up), isGoingRight))
                break;
    ...
    private bool HandleHorzontalSlope(ref Vector2 deltaMovement, float angle, bool isGoingRight) {
